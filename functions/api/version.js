...
// Cloudflare Pages Function: proxy/fallback for /api/version
...
export async function onRequest(context) {
  ...
  const upstream = `${backendUrl}/version`;
  ...
  try {
    ...
    // On failure (timeout, network error, etc.), return fallback version info
